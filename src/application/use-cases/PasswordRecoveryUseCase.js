export default class PasswordRecoveryUseCase {
    ...
    async validateEmail(email) {
        ...
        const codeToSend = existingCode 
            ? existingCode.codeValue 
            : (await this.passwordRecoveryRepository.updateVerificationCode(user.idUser)).codeValue;
        ...
        return {
            message: existingCode ? "Code still available" : "Code Generated Successfully"
        };
    }
